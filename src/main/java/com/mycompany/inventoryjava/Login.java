...
ResultSet rs = null;
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/inventoryjava/shopping-cart-48.png"))); // NOI18N
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(Uid, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)
...
if(Uid.getText().isEmpty()||Upassword.getText().isEmpty()){
    JOptionPane.showMessageDialog(this, "Missing Information");
        ...
        String Query="select * from inventory.usertbl where Uname='"+Uid.getText()+"'and Upassword='"+Upassword.getText()+"'"; 
 try{
     ...
     if(rs.next()){
         ...
         JOptionPane.showMessageDialog(this, "Wrong Password or Login");
     }
     con.close();
